...
data = pd.read_csv('/data/FS_human_footprint/011_data/parts/alls_spcors_abs.txt', header=None).to_numpy().flatten()

data = data[data < 10]
print(np.median(data))
bins = 100
density = stats.gaussian_kde(data)
n, x, _ = plt.pyplot.hist(data, bins=np.linspace(0, 5, bins), 
...
plt.pyplot.savefig('/data/FS_human_footprint/014_results/020_plots/00_distribtion_range.png')